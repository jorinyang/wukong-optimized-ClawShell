...
echo "[W4] 消费Hermes洞察..."
/Library/Frameworks/Python.framework/Versions/3.12/bin/python3 /Users/yangyang/.openclaw/scripts/hermes_insight_consumer.py --poll >> /Users/yangyang/.openclaw/logs/hermes_consumer.log 2>&1
...
TASK_COUNT=$(cat /Users/yangyang/.openclaw/workspace/shared/task-queue.json 2>/dev/null | \
